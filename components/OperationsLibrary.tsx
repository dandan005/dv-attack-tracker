...
const meals: Meal[] = [
  ...
  { name: "Pork Loin Katsu", rarity: "Common main dish", category: "Main dish", effect: "Guild member ATK/HP +5%", ingredients: ["Egg", "Meat", "Wheat"], tags: ["raid"], image: "pork-loin-katsu.jpg" },
  ...
  { name: "Fish & Chips", rarity: "Legendary main dish", category: "Main dish", effect: "Guild member ATK/HP +20%", ingredients: ["Tuna", "Tuna", "Potato", "Potato", "Wheat"], tags: ["raid"], image: "fish-and-chips.jpg" },
  ...
  { name: "Sukiyaki", rarity: "Common main dish", category: "Main dish", effect: "Guild member ATK/HP +5%", ingredients: ["Egg", "Meat", "Lettuce"], tags: ["raid"], image: "sukiyaki.jpg" },
  ...
  { name: "Cheeseburger", rarity: "Rare main dish", category: "Main dish", effect: "Guild member ATK/HP +10%", ingredients: ["Cheese", "Meat", "Wheat"], tags: ["raid"], image: "cheeseburger.jpg" },
  { name: "Miho's Spicy Ramen", rarity: "Epic main dish", category: "Main dish", effect: "Guild member ATK/HP +20%", ingredients: ["Chili", "Chili", "Egg", "Meat", "Wheat"], tags: ["raid"], image: "mihos-spicy-ramen.jpg" },
  ...
  { name: "Tomato Basil Ade", rarity: "Legendary dessert", category: "Dessert", effect: "Wyvern damage +30%", ingredients: ["Basil", "Tomato"], tags: ["raid"], image: "tomato-basil-ade.jpg" },
  { name: "???", rarity: "Legendary appetizer", category: "Appetizer", effect: "Exploration progress +3%", ingredients: [], tags: ["exploration"], image: "question-19.jpg" },
  { name: "???", rarity: "Immortal appetizer", category: "Appetizer", effect: "Exploration progress +5%", ingredients: ["Caviar", "Cheese", "Wheat"], tags: ["exploration"], image: "question-21.jpg" },
  { name: "???", rarity: "Immortal main dish", category: "Main dish", effect: "Guild member ATK/HP +30%", ingredients: [], tags: ["raid"], image: "question-40.jpg" },
  { name: "???", rarity: "Immortal main dish", category: "Main dish", effect: "Guild member ATK/HP +30%", ingredients: [], tags: ["raid"], image: "question-41.jpg" },
  { name: "???", rarity: "Great dessert", category: "Dessert", effect: "Wyvern damage +10%", ingredients: [], tags: ["raid"], image: "question-55.jpg" },
  { name: "???", rarity: "Great dessert", category: "Dessert", effect: "Wyvern damage +10%", ingredients: [], tags: ["raid"], image: "question-56.jpg" },
  { name: "???", rarity: "Mythic dessert", category: "Dessert", effect: "Wyvern damage", ingredients: [], tags: ["raid"], image: "question-62.jpg" },
];
