  ...
  return (
    <>
      ...
      <main className="min-h-screen px-4 pt-6 pb-24 max-w-2xl mx-auto">
        <div className="flex items-end justify-between gap-4 mb-5"><div><p className="eyebrow">CYCLE STARTED {cycleStartISO}</p><h2 className="text-xl sm:text-2xl text-dv-brassLight mt-2">KEEP THE GUILD<br className="sm:hidden" /> ON PACE.</h2></div><div className="text-right shrink-0"><p className="text-[10px] text-slate-300/50">CURRENT DAY</p><p className="text-2xl text-dv-emerald">D{dayNumber}</p></div></div>
        {dayNumber < 3 ? (
